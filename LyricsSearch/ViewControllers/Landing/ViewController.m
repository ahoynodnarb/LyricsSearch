...
@property (nonatomic, strong) LSQueueTableViewController *queueTableViewController;
@end
...
- (void)viewDidLoad {
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [self.mediaPlayerView.widthAnchor constraintEqualToAnchor:self.view.widthAnchor constant:-30],
...
- (void)presentQueue {
    self.queueTableViewController = [[LSQueueTableViewController alloc] initWithPlayerModel:self.playerModel];
    [self presentViewController:self.queueTableViewController animated:YES completion:nil];
}
